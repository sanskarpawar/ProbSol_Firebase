...
public class NewNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar=(Toolbar) findViewById(R.id.newnotetoolbar);
    ...
    private void createNote(String title, String content) {
        ...
        if (fAuth.getCurrentUser() != null) {
            ...
            if (isExist) {
                ...
                FBToast.successToast(NewNoteActivity.this,"Note Updated", FBToast.LENGTH_SHORT);
            } else {
                // CREATE A NEW NOTE
                        ...
                        newNoteRef.setValue(noteMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    FBToast.successToast(NewNoteActivity.this, "Note added to database", Toast.LENGTH_SHORT);
                                } else {
                                    FBToast.warningToast(NewNoteActivity.this, "ERROR: " + task.getException().getMessage(), Toast.LENGTH_SHORT);
                                }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.new_note_delete_btn:
                if (isExist) {
                    ...
                    FBToast.warningToast(this, "Nothing to delete", Toast.LENGTH_SHORT);
                }
                break;
        }
    ...
    private void deleteNote() {
        ...
        fNotesDatabase.child(noteID).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    FBToast.warningToast(NewNoteActivity.this, "Note Deleted", Toast.LENGTH_SHORT);
                    noteID = "no";
                    finish();
                } else {
